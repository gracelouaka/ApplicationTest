...
<div id="top-panel">
    <div id="panel">
        <ul>
            <li><a href="#adduser" class="useradd">Ajout profile</a></li>
    ...
    <div id="content">
        <div id="box">
            ...
            <table width="100%">
                ...
                %>
                <tr>
                    <td class="a-center"><%= profile.getCode()%></td>
                    <td><a href="#"><%= profile.getLibelle()%></a></td>
        ...
        <br />
        <div id="box">
            <h3 id="adduser">Ajouter un profile</h3>
            <form id="form" action="/profiles" method="post">
